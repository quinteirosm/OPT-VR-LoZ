...
<template>
  <a-entity gltf-model="#templeRoom" rotation="0 -180 0" position="0 0 -7">
    <PortalTeleporter material="src: #room-physic-texture" depth="0.1" position="0 1.76 9.691" rotation="0 180 0"
      ...
      :cameraRot="0" />
    <a-entity clickable @click="evt => grabTheThing(evt)" position="0 1 1" rotation="0 0 180">
      <a-entity gltf-model="#wwWand" scale="0.0025 0.0025 0.0025" rotation="0 0 90"></a-entity>
    </a-entity>
